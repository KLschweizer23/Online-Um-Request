...
class BladeOne
{
    ...
    //------------------------personal codes if naa---------------------------//
    public function setCurrentKey($value)
    {
    ...
    protected function compileStartSession()
    {
        return $this->phpTag . "if(empty(session_id())){session_start();} ?>";
    }
    protected function compileInsertPlugins()
    {
        return $this->phpTag . "
    ...
    protected function compileLogoutFunction()
    {
        return $this->phpTag . "
    ...
    protected function compileRoleSetter()
    {
        return $this->phpTag .
        "
    ...
    protected function compileRole($expression = '')
    {
        $role = $this->stripParentheses($expression);
        return $this->phpTag . "if(\$this->currentRole==$role): ?>";
    }
    protected function compileElserole($expression = '')
    {
        $role = $this->stripParentheses($expression);

        return $this->phpTag . "elseif(\$this->currentRole==$role): ?>";
    }
    protected function compileEndrole()
    {
        return $this->phpTag . 'endif; ?>';
    }
    protected function compileRegisterFunction()
    {
        return $this->phpTag . 
        "
    ...
    protected function compileLoginFunction()
    {
        return $this->phpTag .
        "
    ...
    protected function compileMyError()
    {
        $returnMessage = array(
            "none"=>" ",
            "id"=>"Credentials doesn\'t match in our database."
        );
        return $this->phpTag . "\$message = '".$returnMessage[$this->currentKey]."'; if(!empty(\$message)): ?>";
    }
    protected function compileEndMyError()
    {
        return $this->phpTag . 'endif; ?>';
    }
    protected function compileExtraFunctions()
    {
        return $this->phpTag . 
        "
        if (isset(\$_POST['add'])) {
